...
<script type="text/javascript">
	...
	$(function(){
        ...
        $("#saveRemarkBtn").click(function () {
            ...
            $.ajax({
                url: "workbench/activity/saveRemarkInfo.do",
                data: {
                    "activityId": "${a.id}",
        ...
        $("#updateRemarkBtn").click(function () {
            ...
            $.ajax({
                url: "workbench/activity/updateRemarkInfo.do",
                data: {
                    "id": id,
                ...
                success: function (data) {
                    ...
                    if(data.success){
                        //修改备注成功后
                        //更新div中相应的内容，noteContent，editTime，editBy
        ...
        //模态窗口更新按钮
        $("#updateActivityListBtn").click(function () {

            $.ajax({
                url: "workbench/activity/updateDetailPageActivityList.do",
                data:{
                    //从隐藏域中取出需要编辑的市场活动id值
                    "id": $.trim($("#edit-id").val()),
                ...
                success: function (data) {
                    ...
                    if(data.success){
                        ...
                        $("#owner").html(data.a.owner);

                        $("#name").html(data.a.name);
                        $("#startTime").html(data.a.startTime);
                        $("#endTime").html(data.a.endTime);
                        $("#cost").html(data.a.cost);
                        $("#description").html(data.a.description);
        ...
        $("#deleteBtn").click(function () {
            $.ajax({
                url: "workbench/activity/deleteActivityAndActivityRemarkList.do",
                data:{
                    "activityId": "${a.id}"
                },
                type: "post",
...
<input type="hidden" id="edit-id">
        ...
        <div class="modal-dialog" role="document" style="width: 85%;">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabe2">修改市场活动</h4>
                </div>
                <div class="modal-body">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
                    <button type="button" class="btn btn-primary" id="updateActivityListBtn">更新</button>
                </div>
            </div>
        </div>
    </div>
	...
	<div style="position: relative; top: -70px;">
		...
		<div style="position: relative; left: 40px; height: 30px; top: 10px;">
			...
			<div style="width: 300px;position: relative; left: 200px; top: -20px;"><b id="startTime">${a.startDate}</b></div>
			<div style="width: 300px;position: relative; left: 450px; top: -40px; color: gray;">结束日期</div>
			<div style="width: 300px;position: relative; left: 650px; top: -60px;"><b id="endTime">${a.endDate}</b></div>
			<div style="height: 1px; width: 400px; background: #D5D5D5; position: relative; top: -60px;"></div>
			<div style="height: 1px; width: 400px; background: #D5D5D5; position: relative; top: -60px; left: 450px;"></div>
		</div>
