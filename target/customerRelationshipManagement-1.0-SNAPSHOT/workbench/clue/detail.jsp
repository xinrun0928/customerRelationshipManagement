...
<script type="text/javascript">
	...
	$(function(){
        ...
        $("#saveRemarkBtn").click(function () {
            ...
            if($.trim($("#remark").val()) == ""){
                alert("备注信息不能为空，请填写您要备注的市场活动信息内容");
                return;
            }

            $.ajax({
                url: "workbench/clue/saveRemarkInfo.do",
                data: {
                    "clueId": "${c.id}",
                ...
                success: function (data) {
                    ...
                    if(data.success){
                        ...
                        html += '<img title="'+ data.cr.owner +'" src="image/user-thumbnail.png" style="width: 30px; height:30px;">';
                        html += '<div style="position: relative; top: -40px; left: 40px;" >';
                        html += '<h5 id="e'+ data.cr.id +'">'+ data.cr.noteContent +'</h5>';
                        // html += '<font color="gray">线索</font> <font color="gray">-</font> <b>'+ data.cr.fullname +'-'+ data.cr.company +'</b> <small style="color: gray;" id="s'+ data.cr.id +'"> '+ (data.cr.editFlag == 0?data.cr.createTime:data.cr.editTime) +' 由'+ (data.cr.editFlag == 0?data.cr.createBy:data.cr.editBy) +'</small>';
                        html += '<font color="gray">线索</font> <font color="gray">-</font> <b></b> <small style="color: gray;" id="s'+ data.cr.id +'"> '+ (data.cr.editFlag == 0?data.cr.createTime:data.cr.editTime) +' 由 '+ (data.cr.editFlag == 0?data.cr.createBy:data.cr.editBy) +'</small>';
        ...
        $("#bundBtn").click(function () {
            ...
            if($xz.length == 0){
                ...
                //workbench/clue/bund.do?clueId=xxx&aid=xxx&aid=xxx
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $.each(data,function (i,n) {
                    ...
                    html += '<img title="'+ n.owner +'" src="image/user-thumbnail.png" style="width: 30px; height:30px;">';
                    html += '<div style="position: relative; top: -40px; left: 40px;" >';
                    html += '<h5 id="e'+ n.id +'">'+ n.noteContent +'</h5>';
                    // html += '<font color="gray">线索</font> <font color="gray">-</font> <b>'+ n.fullname +'-'+ n.company +'</b> <small style="color: gray;" id="s'+ n.id +'"> '+ (n.editFlag == 0?n.createTime:n.editTime) +' 由'+ (n.editFlag == 0?n.createBy:n.editBy) +'</small>';
                    html += '<font color="gray">线索</font> <font color="gray">-</font> <b></b> <small style="color: gray;" id="s'+ n.id +'"> '+ (n.editFlag == 0?n.createTime:n.editTime) +' 由'+ (n.editFlag == 0?n.createBy:n.editBy) +'</small>';
                    html += '<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">';
    ...
    function deleteRemark(id){
        $.ajax({
            url: "workbench/clue/deleteRemarkInfo.do",
            data: {
                id: id
            },
            type: "post",
