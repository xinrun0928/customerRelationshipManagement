...
<%@ page import="com.zhang.crm.settings.domain.DicValue" %>
<%@ page import="java.util.Map" %>
<%@ page import="java.util.Set" %>
<%@ page import="com.zhang.crm.workbench.domain.Tran" %>
...
//准备字典类型为stage的字典值的列表
    ...
    //根据propertiesMap准备properties中的key集合
...
<script type="text/javascript">
    ...
    function changeIcon(stage,i) {
        ...
        //如果当前阶段的可能性为0，前7个一定是黑圈，后面两个，一个是红叉，一个是黑叉
...
<body>
	...
	<div style="position: relative; left: 40px; top: -50px;">
        ...
        <%
            ...
            //准备当前阶段的可能性
            String currentPossibility = propertiesMap.get(currentStage);
            ...
            if("0".equals(currentPossibility)){
                ...
                for(int i = 0; i < dicValueList.size(); i++){
                    ...
                    String listPossibility = propertiesMap.get(listStage);
        ...
        <%
            ...
            }else { //如果当前的可能性不为0，前7个有可能性是绿圈，绿色标记，黑圈，后两个一定是黑叉
                //准备当前阶段的下标
                int index = 0;
                for(int i = 0; i < dicValueList.size(); i++){
        ...
        %>
                        ...
                        -----------
        <%
                    }else {//如果遍历出来的阶段的可能性不为0，说明是前7个阶段，绿圈，绿标，黑圈
